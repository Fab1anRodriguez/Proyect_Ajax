...
// prueba sin el session_start
$usuario_temporal_id = 1; // simula el usuario logueado
$sala_temporal_id = 2;    // simula la sala actual

// rrta de los avatares
...
$sql = $con->prepare("SELECT username, vida, Puntos, avatar.imagen
                ...
                INNER JOIN avatar ON usuario.ID_avatar = avatar.ID_avatar
                WHERE ID_usuario = ?");
$sql->execute([$usuario_temporal_id]);
...
<body>
        ...
        <main>
            ...
            <div class="jugadores-grid">
                <?php foreach($jugadores as $jugador): ?>
                    <?php if($jugador['ID_usuario'] != $usuario_temporal_id): ?>
    ...
    <script>
        ...
        const USUARIO_ACTUAL_ID = <?php echo $usuario_temporal_id; ?>;
        const SALA_ACTUAL_ID = <?php echo $sala_temporal_id; ?>;
